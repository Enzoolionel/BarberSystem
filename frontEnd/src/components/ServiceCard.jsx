const ServiceCard = ({ icon, title, description }) => {
  return (
    <div className="xl:w-96 h-64 bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden group hover:shadow-2xl transition duration-300 ease-in-out">
      ...
      <div className="p-4 bg-secundario text-white text-center rounded-b-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
